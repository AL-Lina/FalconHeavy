...
class RocketView: UIView {
    ...
    private func setupViews() {
        ...
        collectionView.register(RocketCollectionViewCell.self, forCellWithReuseIdentifier: idRocketInfoTableViewCell)
    }
...
extension RocketView: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: idRocketInfoTableViewCell, for: indexPath) as! RocketCollectionViewCell
        return cell
    }
}
